# 1 "c:\\Users\\Lenovo\\Documents\\_BERDWARE\\7.0_BerDrums\\_testing\\pyduino_midi\\src\\main.cpp"
# 1 "c:\\Users\\Lenovo\\Documents\\_BERDWARE\\7.0_BerDrums\\_testing\\pyduino_midi\\src\\main.cpp"
/*
...
*/
# 18 "c:\\Users\\Lenovo\\Documents\\_BERDWARE\\7.0_BerDrums\\_testing\\pyduino_midi\\src\\main.cpp"
# 19 "c:\\Users\\Lenovo\\Documents\\_BERDWARE\\7.0_BerDrums\\_testing\\pyduino_midi\\src\\main.cpp" 2
...
unsigned short ledPinsArray[6 /*nano can be 8, mega can be 16*/];
unsigned short piezoPinsArray[6 /*nano can be 8, mega can be 16*/];
unsigned int thresholdArray[6 /*nano can be 8, mega can be 16*/];
unsigned int noteArray[6 /*nano can be 8, mega can be 16*/];

// Intialize machine state and config values
unsigned short state = 0; // 0 for play state
                          // 1 for configure state
unsigned int configMatrix[5][6 /*nano can be 8, mega can be 16*/] = {};
...
void setupInitialValues(){
  ...
  for (short i=0; i<6 /*nano can be 8, mega can be 16*/; i++){
    if (i<6){
...
void setDeviceValues(String serialData){
  ...
  */
# 199 "c:\\Users\\Lenovo\\Documents\\_BERDWARE\\7.0_BerDrums\\_testing\\pyduino_midi\\src\\main.cpp"
...
void drumRoutine(){
  ...
  for (short i; i<6 /*nano can be 8, mega can be 16*/; i++){
